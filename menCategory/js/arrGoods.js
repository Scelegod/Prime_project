...
for(let sideBtn of allSidenavBtn){
    sideBtn.addEventListener('click', function func(e){
        ulBtn(sidenav__btnPants,   'goods__block pants_men',   "new_models", "discount", 'dispNone', e);
        ulBtn(sidenav__btnJacket,  'goods__block jacket_men',  "new_models", "discount", 'dispNone', e);
        ulBtn(sidenav__btnHoodies, 'goods__block hoodies_men', "new_models", "discount", 'dispNone', e);
        ulBtn(sidenav__btnJeans,   'goods__block jeans_men',   "new_models", "discount", 'dispNone', e);
        ulBtn(sidenav__btnHomclot, 'goods__block homclot_men', "new_models", "discount", 'dispNone', e);
        ulBtn(sidenav__btnTshirts, 'goods__block tshirts_men', "new_models", "discount", 'dispNone', e);
        ulBtn(sidenav__btnShoes,   'goods__block shoes_men',   "new_models", "discount", 'dispNone', e);
