...
if(cartData !== null){
  ...
  for(var items in cartData){
      totalItems += `<div class="goods__block__basket" data-id="${items}">
              ...
              <button class="basket__amoynt__btn" data-action="minus"><img data-action="minus" class="basket__icons__minus" src="./../icons/minus.svg"></button>
              <p class="basket__amoynt__number" data-count="${items}">${cartData[items][2]}</p>
              <button class="basket__amoynt__btn" data-action="plus"><img data-action="plus" class="basket__icons__plus" src="./../icons/plus.svg"></button>
              </div>
              <span class="basket__text_price_ruble"><span class="basket__text_price">${cartData[items][1]}</span> ₽</span>
              <p class="basket__icons"><img class="basket__icons__cancel" src="./../icons/cancel.svg" data-del="${items}"></p>
              </div>`;
  }
